...
"""
    ...
    if checklist_titles:
        hints_lines = [
            ...
            "1) Для КАЖДОГО пункта применяй ТОЛЬКО критерий из блока «Критерий пункта» ниже. Название пункта служит только для идентификации.",
            "2) Если критерий содержит строки «ДА ЕСЛИ», «НЕТ ЕСЛИ», «НЕ УЧИТЫВАТЬ», используй их как основные правила.",
            "3) При сомнении или отсутствии явного подтверждения в диалоге ставь [ОТВЕТ: НЕТ].",
            ...
            "5) После всех пунктов добавь блок <общая оценка>...</общая оценка>.",
            "Критерии по пунктам:"
        ]
