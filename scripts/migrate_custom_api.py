#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Применяет scripts/migration_custom_api.sql к PostgreSQL."""
...
def run_migration():
    sql_path = Path(__file__).resolve().parent / "migration_custom_api.sql"
    ...
    try:
        ...
        logger.info("Миграция custom_api выполнена успешно.")
